...
class SEGRPNHead(AnchorHead):
    ...
    def forward_train(self,
        ...
        if proposal_cfg is None:
            ...
            seg_scores_sig = [each.detach().sigmoid() for each in outs[2]]
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, loss_seg = multi_apply(
            self.loss_single,
            cls_scores,
            bbox_preds,
            seg_scores,
        ...
        return dict(loss_rpn_cls=losses_cls, loss_rpn_bbox=losses_bbox, loss_rpn_seg=loss_seg)
